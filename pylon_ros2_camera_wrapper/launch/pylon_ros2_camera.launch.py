            ...
            Node(
                ...
                parameters=[
                    config_file,
                    {
                        ...
                        'pylon_ros2_camera_node.image_rect.ffmpeg.preset': "p1",
                        'pylon_ros2_camera_node.image_rect.ffmpeg.tune': "ull",
                        'pylon_ros2_camera_node.image_rect.ffmpeg.gop_size': 10,
                        'pylon_ros2_camera_node.image_rect.ffmpeg.delay': 0
                    }
                ]
            ),
        ]
